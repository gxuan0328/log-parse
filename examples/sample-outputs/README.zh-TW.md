...
| `iis_taipei_2026-05-21.txt`                | 台北 IIS 指標 — 狀態碼分佈、Top 端點                              | `bash bin/analyze_iis.sh --log-dir ./examples/sample-logs/LUNG-CANCER-REPORT-LOG --date 2026-05-21 --region taipei`                                                                   |
